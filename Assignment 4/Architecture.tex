...
\begin{enumerate}
\item Concurrency view instead of privacy. The privacy was redundant given that all the functionality can be shown in the functional decomposition view. 
\item The requirements are stated in Appendix A
\item Clear mapping between domain analysis (Appendix C) and design decisions (Appendix B)
\item Rationale behind each view is explained in more detail
\item Added Appendix D to show our reflection on the viewpoints 
\end{enumerate}
